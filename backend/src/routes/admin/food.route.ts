...
export const foodRouter = (context: AppContext) => {

    const router = Router();

    const adminFoodsController = new AdminFoodsController(context);
