...
export const productRouter = (context: AppContext) => {

    const router = Router();

    const adminProductsController = new AdminProductsController(context);
    ...
    router.get(
        "/:id",
        authenticateJWT,
        adminProductsController.getFood
    );
    ...
    router.post(
        ...
        adminProductsController.editFood
    );
